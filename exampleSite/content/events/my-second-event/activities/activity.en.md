...
speakers: ["maria-vrabie", "will-eastbury"] # The urlized version of the group, so that it can be displayed on the group's page.
title: "Bots, Bots and more bots!" # Name of the organizer
